...
<section class="relative isolate">
  ...
  <!-- NO GRADIENT: flat emerald scrim (same vibe as your sidebar/buttons) -->
  <div class="absolute inset-0 -z-10 bg-emerald-800/85 -mt-10" aria-hidden="true"></div>

  <!-- subtle “paper depth” ring, still not a gradient -->
  <div class="absolute inset-0 -z-10 ring-1 ring-inset ring-white/10 -mt-10" aria-hidden="true"></div>
