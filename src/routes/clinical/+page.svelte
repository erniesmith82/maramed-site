      ...
      >
        ...
        {:else}
          <ul class="mt-4 space-y-4">
            {#each studies as s, i}
              <li
                class="rounded-xl border border-slate-200/70 bg-slate-50/50 p-4 sm:p-5 hover:bg-slate-50 transition"
                in:fly={{ x: sx(i + 1), y: sy(i + 1), duration: T(320), delay: D(100 + i * 40) }}
              >
